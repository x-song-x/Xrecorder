unction varargout = Xrecorder3(varargin)
...
% Xrecorder3pre2 is the version w/ new GUI (Panelette3) and Mag
...
rec.UI.M =          1.2;          %   GUI Magnification
SetupFigureRec;

%% Setup Callbacks
set(rec.UI.H.hMic_RockerA,          'SelectionChangeFcn',   'Xrecorder3(''GUI_Rocker'')');
set(rec.UI.H.hMic_RockerB,          'SelectionChangeFcn',   'Xrecorder3(''GUI_Rocker'')');
set(rec.UI.H.hAmpMode_RockerA,      'SelectionChangeFcn',   'Xrecorder3(''GUI_Rocker'')');
set(rec.UI.H.hAmpMode_RockerB,      'SelectionChangeFcn',   'Xrecorder3(''GUI_Rocker'')');
set(rec.UI.H.hAmpFilter_Rocker,     'SelectionChangeFcn',   'Xrecorder3(''GUI_Rocker'')');

set(rec.UI.H.hAmpGainA_Toggle1,     'SelectionChangeFcn',	'Xrecorder3(''GUI_Toggle'')');
set(rec.UI.H.hAmpGainA_Toggle2,     'SelectionChangeFcn',	'Xrecorder3(''GUI_Toggle'')');
set(rec.UI.H.hAmpGainB_Toggle1,     'SelectionChangeFcn',	'Xrecorder3(''GUI_Toggle'')');
set(rec.UI.H.hAmpGainB_Toggle2,     'SelectionChangeFcn',	'Xrecorder3(''GUI_Toggle'')');

set(rec.UI.H.hDAQ_AI_ChA_Toggle1,   'SelectionChangeFcn',	'Xrecorder3(''GUI_Toggle'')');
set(rec.UI.H.hDAQ_AI_ChA_Toggle2,   'SelectionChangeFcn',	'Xrecorder3(''GUI_Toggle'')');
set(rec.UI.H.hDAQ_AI_ChB_Toggle1,   'SelectionChangeFcn',	'Xrecorder3(''GUI_Toggle'')');
set(rec.UI.H.hDAQ_AI_ChB_Toggle2,   'SelectionChangeFcn',	'Xrecorder3(''GUI_Toggle'')');
