...
%
%   Panelette: for mimicing NI CA-1000 Panelettes as of 2010
%       Supporting Panelettes:
%           ToggleSwitch
%           RockerSwitch
%           MomentarySwitch
%           Potentiometer
...
%           *Edit
%   Panelette2: 
%       Supporting Panelettes (additional):
%           *CheckBox
%           *PopupMenu
%   Panelette3 supports GUI scaling, by 'S.M'
...
try
    ...
    S.TextFont = 7*S.M;                                     % small text font
            ...
            for j = 1:2
                ...
                hh = uipanel(...
                    ...
                    'Position',             [S.LEDWidth*(j-1) + S.SP*j,...
                                            ...
                                            S.LEDWidth, S.LEDHeight]*S.M);
                % LED 
                hhh = uicontrol(...
                    'parent',               hh,...
                    'style',                'pushbutton',...
                    'enable',               'inactive',...
                    'Position',             [S.S, S.S, S.LEDWidth-3*S.S, S.LEDWidth-3*S.S]*S.M,...
                ...
                hhhh = uicontrol(...
                    ...
                    'position',             [0,S.LEDHeight-S.LEDTitleHeight-S.S,...
                                            S.LEDWidth-S.S, S.LEDTitleHeight]*S.M);
        ...
        for i = 1:2
            ...
            hh = uibuttongroup(...
                    ...
                    'position',             [S.SP + (S.ToggleGroupWidth+S.S)*(i-1), S.SP,...
                                            S.ToggleGroupWidth, S.ButtonGroupHeight]*S.M);
            ...
            hhh = uicontrol(...
                    ...
                    'HorizontalAlignment',  'left',...
                   	'position',             [S.SP + (S.ToggleGroupWidth+S.S)*(i-1), S.SP+S.ButtonGroupHeight + S.S,...
                                            S.ToggleGroupWidth, S.ButtonTitleHeight]*S.M);
        ...
        for i = 1:1
            ...
            hh = uibuttongroup(...
                    ...
                    'position',             [S.SP + (S.RockerGroupWidth+S.S)*(i-1), S.SP,...
                                            S.RockerGroupWidth, S.ButtonGroupHeight]*S.M);
            % Toggle Buttons in the Group
            for j = buttonnum:-1:1
                hhh(j) = uicontrol(...
                    'Parent',               hh,...
            ...
            hhh = uicontrol(...
                    ...
                    'position',             [S.SP, S.SP + S.ButtonGroupHeight + S.S,...
                                            S.RockerGroupWidth, S.ButtonTitleHeight]*S.M);
         	% register Toggle Switch handles to global TPLSM
            eval(strcat(WP.handleseed,'{',num2str(WP.row),',',num2str(WP.column),...
            ...
            for j = 1:buttonnum      
                ...
                hh(j) = uipanel(...
                    ...
                    'position',             [S.SP+(S.RockerGroupWidth+S.S)*(i-1),...
                                            ...
                                            S.RockerGroupWidth,...
                                            	round(S.ButtonGroupHeight/3) ]*S.M);
                % CheckBoxes
                hhh(j) = uicontrol(...
                    'Parent',               hh(j),...
                    'Style',                'checkbox',...
...
%                 end
                ...
                % end
                if isfield(WP,'inputEnable')
                    if isnan(WP.inputEnable(i,j))||~WP.inputEnable(i,j)
                        set(hhh(j), 'Enable',   'off');
                    else
                        set(hhh(j), 'Enable',   'on');
                    end
                end
    ...
    case 'Potentiometer'
        ...
        hh =uicontrol(...
                    ...
                    'position',             [2*S.SP+S.SliderWidth, S.SP+S.SliderHeight-S.EditHeight,...
                                            S.PaneletteWidth - 3*S.SP - S.SliderWidth, S.EditHeight]*S.M,...
        ...
        hhh = uicontrol(...
                    ...
                    'BackgroundColor',      S.Color.TextBG,...
                    'ForegroundColor',      S.Color.FG,...
                    'position',             [S.SP, S.SP, S.SliderWidth, S.SliderHeight]*S.M,...
                    'Min',                  WP.inputRange(1),...
        ...
        hhhh = uicontrol(...
                    ...
                    'position',             [2*S.SP+S.SliderWidth, S.SP,...
                                            S.PaneletteWidth - 3*S.SP - S.SliderWidth-S.S, S.SliderHeight-20-S.SP]*S.M,...
    ...
    case 'MomentarySwitch'
        ...
        hhh1 = uicontrol(...
                    ...
                    'Position',             [S.SP + S.S, S.SP + S.MomenTextHeight + S.MomenSpacer + S.MomenWidth + S.S,...
                                            S.EditWidth - S.S, S.MomenTextHeight - S.S]*S.M);
        hhh2 = uicontrol(...
                    'parent',               h,...
                    'style',                'text',....
                    'units',                'pixels',...
        ...
        for i = 1:2           
            ...
            hhh = uicontrol(...
                    ...
                    'position',             [S.SP+S.S,...
                                            ...
                                            S.EditWidth-2*S.S, S.EditTextHeight]*S.M,...
                  	'string',               sprintf(WP.text{i})...
                );
            eval(strcat(WP.handleseed,'{',num2str(WP.row),',',num2str(WP.column),...
                    '}.hEdit{',num2str(i),'}=hh;')); 
